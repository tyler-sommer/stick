...
func TestFilters(t *testing.T) {
	...
	tests := []struct {
		...
		{"reverse", func() stick.Value { return stickSliceToString(filterReverse(nil, []string{"a", "b", "c"})) }, "c.b.a"},
		{"reverse", func() stick.Value { return stickSliceToString(filterReverse(nil, []int{1, 2, 3})) }, "3.2.1"},
